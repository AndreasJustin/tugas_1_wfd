...
@section('content')
    <div class="min-w-screen flex flex-col justify-center items-center h-screen background">
        ...
        <div class="w-9/12 gap-y-4 justify-center items-center flex flex-col">
            <h1 class="font-bold text-4xl xl:text-8xl text-white text-center cinzel-regular">Food<span class="text-red-700">Nesia</span> – Authentic Indonesian Flavors, Served with Love</h1>
            <h1 class="text-lg xl:text-4xl text-white text-center p-2 lora-regular">Explore the best of Indonesian cuisine, freshly made just for you.</h1>
            <button type="button"
            ...
            data-twe-ripple-init><a href="#best" class="text-lg xl:text-xl">Get Started</a></button>
        </div>
    </div>

    
    <div id="best" class="min-w-screen flex flex-col h-screen bg-[#926522] justify-center items-center">
        <h1 class="p-5 font-bold text-4xl xl:text-8xl text-white text-center cinzel-regular">Here's our best menu!</h1>
        <div class="swiper mySwiper w-9/12 min-[550px]:w-1/2 h-1/2 pt-5">
            <div class="swiper-wrapper">
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        ...
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/ayam goreng.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
                        ...
                        <p class="mb-4 text-xs sm:text-sm xl:text-base text-left mulish-regular">
                    ...
                    <div class="flex flex-col w-full items-center">
                        <button type="button"
                            class="inline-block w-auto rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2"
                            data-twe-ripple-init data-twe-ripple-color="light">
                            <div class="flex flex-row justify-between items-center gap-x-2">
                                <h1 class="oswald-regular">Add</h1>
                                <img src="{{ asset('asset/image/plus-large-svgrepo-com.svg') }}" class="!w-[15px]"
                                    alt="">
                            </div>
                        </button>
                    </div>
                ...
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        data-twe-ripple-color="light">
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/bakso.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
                ...
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        data-twe-ripple-color="light">
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/mie goreng.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
                ...
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        data-twe-ripple-color="light">
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/nasgor.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
                ...
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        data-twe-ripple-color="light">
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/rawon.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
                ...
                <div class="swiper-slide block rounded-lg bg-white shadow-secondary-1">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat" data-twe-ripple-init
                        data-twe-ripple-color="light">
                        <img class="rounded-t-lg !h-[200px]" src="{{ asset('asset/image/rendang.jpg') }}"
                            alt="" />
                    </div>
                    <div class="py-3 px-6 text-surface flex flex-col w-full justify-between items-center">
